...
import { useIsMobile, useIsOverlay } from "@/hooks/use-mobile"
...
>(
  (
    ...
    }, [isMobile, isOverlay, setOpen, setOpenMobile, setOpenOverlay])
    ...
    const contextValue = React.useMemo<SidebarContext>(
      ...
      [state, open, setOpen, isMobile, openMobile, setOpenMobile, openOverlay, setOpenOverlay, isOverlay, toggleSidebar]
    )
...
>(
  (
    ...
    const { isMobile, isOverlay, state, openMobile, setOpenMobile, openOverlay, setOpenOverlay } = useSidebar()
    ...
    if (isMobile || isOverlay) {
      return (
        <Sheet open={isMobile ? openMobile : openOverlay} onOpenChange={isMobile ? setOpenMobile : setOpenOverlay} {...props}>
          <SheetContent
