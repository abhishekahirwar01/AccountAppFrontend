...
const TemplateA5_2PDF: React.FC<TemplateA5PDFProps> = ({
  ...
  // Bank data setup from Template 1
        ...
        return (
          <Page key={pageIndex} size="A5" style={templateA5_3Styles.page}>
            ...
            <View style={templateA5_3Styles.section}>
              {/* table header  */}
              <View style={templateA5_3Styles.tableHeader} fixed>
                {company?.gstin && (
              ...
              {/* table three columns */}
              <View style={templateA5_3Styles.threeColSection} fixed>
                  ...
                  {/* QR Code Section */}
                  {
                    ...
                    bankData?.qrCode && (
                      ...
                      >
                        ...
                        >
                          <Image
                            src={`${process.env.NEXT_PUBLIC_BASE_URL}/${bankData.qrCode}`}
                            style={{
                              width: 80,
                              height: 80,
                              objectFit: "contain",
              ...
              <View style={templateA5_3Styles.tableContainer}>
                ...
                <View
                  style={[
                    templateA5_3Styles.columnBackground,
                    {
                ...
                <View style={templateA5_3Styles.itemsTable}>
                  {/* Table Header */}
                  <View style={templateA5_3Styles.itemsTableHeader} fixed>
                    <Text
                      style={[
                    ...
                    {showIGST ? (
                      ...
                      <>
                        <View
                          style={[
                            templateA5_3Styles.igstTotal,
                            { width: colWidths[6], paddingRight: 6 },
                          ]}
                        >
              ...
              {isLastPage && (
                <>
                  ...
                  >
                    <Text
                      style={[
                        templateA5_3Styles.totalInWords,
                        { borderBottom: 0 },
                      ]}
                    >
                    ...
                    {isGSTApplicable && (
                      <View style={templateA5_3Styles.hsnTaxTable}>
                        ...
                        {(() => {
                          ...
                          // Calculate vertical border positions for HSN/SAC Tax Table
                          const borderPositionsHSN: number[] = [];
                          let cumulativeHSN = 0;
                          for (let i = 0; i < hsnColWidths.length - 1; i++) {
                            cumulativeHSN += parseFloat(hsnColWidths[i]);
                            borderPositionsHSN.push(
                              (cumulativeHSN / 100) * 318
                            ); // Use table width for A5 (adjust if needed)
                          }
